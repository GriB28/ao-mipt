...
def make_eligible(user, **profile_fields):
    ...
    defaults = {
        ...
        "doc_number": "0000 000000", "doc_issued_at": date(2024, 1, 10),
        "doc_issued_by": "МВД", "reg_address": "Москва",
        "parent_last_name": "Тестова", "parent_first_name": "Анна",
        "parent_doc_type": DocumentType.PASSPORT_RF, "parent_doc_number": "0000 000001",
        "parent_doc_issued_at": date(2015, 1, 1), "parent_doc_issued_by": "МВД",
        "parent_reg_address": "Москва",
    } | profile_fields
