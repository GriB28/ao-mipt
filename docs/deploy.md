...
Файлы решений и сканы согласий лежат в томе `media`, но по прямому адресу
`/media/solutions/...` и `/media/consents/...` nginx их не отдаёт никому. Ссылки на сайте ведут
